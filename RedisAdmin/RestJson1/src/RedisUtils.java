...
public class RedisUtils {
    ...
    SortedMap<Long, Jedis> hashServ = null;
	public static void getEmployeeById(int id,SortedMap<Long, Long> hashKeyhashServ,SortedMap<Long, Jedis> hashServ){
        ...
        for(Long hashKeyhashServVal:hashKeyhashServ.keySet()){
        	Long val = hashKeyhashServ.get(hashKeyhashServVal);
                            if(hashSlot < val){
                               ...
                               System.out.println(tmp+"Yay is hashslot is "+hashSlot +" servKey is "+tmpNode.get(tmp));//+"INFO"+tmpNode.info("keyspace")); 
                               //  System.out.println("yay!!"+ tmpNode.get("-8145972860225622484"));
                                break;
                            }
                        }
      }
    ...
    public static void createLargeRecords(){
          ...
          SortedMap<Long, Jedis> hashServ= hashAndInsertNodesToMap(redisNodes);
          SortedMap<Long, Long> hashKeyhashServ = hashAndInsertToServMap(empArr,hashServ);
          Set<Long> hashKeyhashServKeys = hashKeyhashServ.keySet();
          int i=1;
          Jedis node = null;
          Employee emp = null;
	...
	public void deleteServer(Jedis ser, SortedMap<Long, Jedis> hashServ) {
